...
(function () {
  const DICT = {
    en: {
      // nav
      nav_home:"Home", nav_event:"Event", nav_progress:"Activity", nav_calories:"Calories", nav_profile:"Profile", nav_scan:"Scan",
      logout:"Log Out",
      book_title:"Book at 20FIT", book_class:"Book a class", book_consult:"Book a doctor consultation",
      book_recmed:"Based on your results, book a session at the 20FIT clinic.",
      // dashboard
      welcome:"Welcome",
      sec_weather:"Weather & Air Quality", sec_breath:"Breathing Exercise",
      sec_checklist:"Today's Checklist", sec_cycle:"Menstrual Cycle",
      ...
      bs_kick:"Body scan", bs_title:"Body Scan",
      bs_sub:"Body composition results from the scale at 20FIT locations.",
      cal_ed_t:"Edit food", cal_ed_name:"Name", cal_ed_meal:"Meal", cal_ed_kcal:"Calories",
      cal_ed_p:"Protein (g)", cal_ed_c:"Carbs (g)", cal_ed_f:"Fat (g)", cal_ed_save:"Save", cal_ed_cancel:"Cancel",
      ...
      rec_articles_h:"Articles",
      rec_recipes_h:"Recipes",
      rec_search:"Search recipes…",
      act_title:"Activity",
      act_sec_workout:"Workout", act_sec_ai:"AI Coach", act_sec_nutri:"Nutrition",
      act_sec_habit:"Daily habits", act_sec_week:"Training volume this week",
      act_up_t:"Upload your workout", act_up_s:"Screenshot, photo, or file from your tracker \u2014 up to 5 at once",
      act_up_or:"or connect directly", act_uploading:"Uploading\u2026",
      act_up_fail:"Upload failed. Try again.", act_too_big:"File is larger than 5MB.",
      act_trk_soon:"Tracker sync isn't connected yet. For now, upload a screenshot or add the workout manually.",
      act_no_workout:"No workout recorded for this day.", act_add_manual:"Add manually",
      act_st_dist:"Distance", act_st_dur:"Duration", act_st_hr:"Avg BPM", act_st_kcal:"Calories",
      act_hrz:"Heart rate zones", act_has_file:"File attached", act_delete:"Delete",
      act_del_confirm:"Delete this workout?",
      act_ai_t:"Overall analysis", act_ai_none:"No plan for this day yet.",
      act_ai_gen:"Generate plan", act_ai_regen:"Regenerate plan", act_ai_working:"Working\u2026",
      act_ai_fail:"Couldn't generate the plan. Try again.", act_ai_nofb:"NO AI",
      act_need_t:"Add a workout first", act_need_b:"The coach reads your workout \u2014 distance, duration, heart-rate zones \u2014 to build the plan. Add one and the analysis shows up here.",
      act_need_1:"Upload a screenshot, photo, or file from your tracker", act_need_2:"Or connect Strava, Garmin, Apple Health, or Google Fit",
      act_need_3:"Or type the workout in by hand", act_need_cta:"Take me there", act_need_back:"Back", act_need_any:"Build a plan from my daily habits only",
      act_goal_cta:"Set your goal",
      act_coach_cta:"Weekly workout program", act_coach_sub:"Answer a quick quiz — no workout upload needed",
      act_score:"Score", act_no_gap:"Not enough data yet.",
      act_goal_t:"AI Coach Plan", act_goal_fail:"Couldn't save that. Try again.",
      act_cat_exercise:"Exercise", act_cat_nutrition:"Nutrition", act_cat_habit:"Habit", act_cat_recovery:"Recovery",
      act_h_sleep:"Sleep", act_h_water:"Water", act_h_steps:"Steps", act_h_breath:"Breathing",
      act_empty:"not set", act_done:"done",
      act_wk_km:"km this week", act_wk_n:"workouts",
      act_dlg_t:"Workout details", act_dlg_s:"Fill in only what you know. Blanks won't be guessed.",
      act_f_title:"Workout name", act_f_type:"Type", act_f_dur:"Duration (minutes) *",
      act_f_dist:"Distance (km)", act_f_kcal:"Calories burned", act_f_hr:"Average BPM",
      act_need_dur:"Duration is required and must be more than 0.",
      act_save_fail:"Couldn't save. Try again.", act_save:"Save", act_cancel:"Cancel",
      act_load_fail:"Couldn't load activity data.", act_retry:"Try again",
      nav_activity:"Activity",
      rec_nutrition:"Nutrition estimate",
      rec_portions:"How many servings?",
      rec_portion_word:"serving",
      rec_est_for:"for {n} serving(s) (estimate)",
      rec_ing_scale_badge:"×{n} of the original recipe",
      rec_ing_scale_note:"Ingredient amounts below are scaled automatically (estimated from text). Items without a clear amount (e.g. “to taste”) are left as-is — double-check unusual ones.",
      rec_all_cat:"All categories",
      rec_all_kcal:"All calories",
      rec_sort_default:"Sort",
      rec_results:"recipes",
      rec_reset:"Reset",
      rec_min:"min",
      rec_by:"by",
      ...
      rec_all:"All",
      rec_art_empty:"No articles here yet.",
      rec_art_err:"Couldn't load articles.",
      rec_retry:"Try again",
      rec_save:"Save",
      rec_saved:"Saved",
      rec_saved_h:"Saved recipes",
      rec_saved_loading:"Loading your saved recipes…",
      rec_saved_none:"Nothing saved yet. Open a recipe and tap Save to keep it here.",
      rec_saved_err:"Couldn't load your saved recipes.",
      rec_saved_gone:"{n} saved recipe(s) are no longer available.",
      rec_consent_required:"Please agree to the consent first.",
    ...
    id: {
      nav_home:"Beranda", nav_event:"Event", nav_progress:"Aktivitas", nav_calories:"Kalori", nav_profile:"Profil", nav_scan:"Scan",
      logout:"Keluar",
      book_title:"Booking di 20FIT", book_class:"Booking kelas", book_consult:"Booking konsultasi dokter",
      book_recmed:"Berdasarkan hasilmu, booking sesi di klinik 20FIT.",
      welcome:"Selamat datang",
      sec_weather:"Cuaca & Kualitas Udara", sec_breath:"Latihan Pernapasan",
      sec_checklist:"Checklist Hari Ini", sec_cycle:"Siklus Menstruasi",
      ...
      bs_kick:"Body scan", bs_title:"Body Scan",
      bs_sub:"Hasil timbangan komposisi tubuh di lokasi 20FIT.",
      cal_ed_t:"Ubah makanan", cal_ed_name:"Nama", cal_ed_meal:"Waktu makan", cal_ed_kcal:"Kalori",
      cal_ed_p:"Protein (g)", cal_ed_c:"Karbo (g)", cal_ed_f:"Lemak (g)", cal_ed_save:"Simpan", cal_ed_cancel:"Batal",
      ...
      rec_articles_h:"Artikel",
      rec_recipes_h:"Resep",
      rec_search:"Cari resep…",
      act_title:"Activity",
      act_sec_workout:"Workout", act_sec_ai:"AI Coach", act_sec_nutri:"Nutrisi",
      act_sec_habit:"Kebiasaan harian", act_sec_week:"Volume latihan minggu ini",
      act_up_t:"Upload hasil workout", act_up_s:"Screenshot, foto, atau file dari tracker kamu \u2014 bisa 5 sekaligus",
      act_up_or:"atau hubungkan langsung", act_uploading:"Mengunggah\u2026",
      act_up_fail:"Gagal mengunggah. Coba lagi.", act_too_big:"Ukuran berkas lebih dari 5MB.",
      act_trk_soon:"Sinkronisasi tracker belum tersambung. Untuk sekarang, unggah screenshot atau isi workout manual.",
      act_no_workout:"Belum ada workout tercatat di hari ini.", act_add_manual:"Isi manual",
      act_st_dist:"Jarak", act_st_dur:"Durasi", act_st_hr:"Rata BPM", act_st_kcal:"Kalori",
      act_hrz:"Zona detak jantung", act_has_file:"Ada berkas terlampir", act_delete:"Hapus",
      act_del_confirm:"Hapus workout ini?",
      act_ai_t:"Analisis keseluruhan", act_ai_none:"Belum ada rencana untuk hari ini.",
      act_ai_gen:"Buat rencana", act_ai_regen:"Buat ulang rencana", act_ai_working:"Sedang diproses\u2026",
      act_ai_fail:"Gagal membuat rencana. Coba lagi.", act_ai_nofb:"TANPA AI",
      act_need_t:"Tambahkan workout dulu", act_need_b:"Coach membaca workout kamu \u2014 jarak, durasi, zona detak jantung \u2014 untuk menyusun rencananya. Tambahkan satu, analisisnya muncul di sini.",
      act_need_1:"Upload screenshot, foto, atau file dari tracker kamu", act_need_2:"Atau sambungkan Strava, Garmin, Apple Health, atau Google Fit",
      act_need_3:"Atau isi workout-nya manual", act_need_cta:"Bawa ke sana", act_need_back:"Kembali", act_need_any:"Buat rencana dari data harian saja",
      act_goal_cta:"Tentukan targetmu",
      act_coach_cta:"Program latihan mingguan", act_coach_sub:"Jawab quiz singkat — tanpa perlu upload workout",
      act_score:"Skor", act_no_gap:"Datanya belum cukup.",
      act_goal_t:"Rencana AI Coach", act_goal_fail:"Gagal menyimpan. Coba lagi.",
      act_cat_exercise:"Latihan", act_cat_nutrition:"Nutrisi", act_cat_habit:"Kebiasaan", act_cat_recovery:"Pemulihan",
      act_h_sleep:"Tidur", act_h_water:"Air", act_h_steps:"Langkah", act_h_breath:"Napas",
      act_empty:"belum diisi", act_done:"selesai",
      act_wk_km:"km minggu ini", act_wk_n:"sesi workout",
      act_dlg_t:"Detail workout", act_dlg_s:"Isi yang kamu tahu saja. Yang kosong tidak akan ditebak.",
      act_f_title:"Nama workout", act_f_type:"Jenis", act_f_dur:"Durasi (menit) *",
      act_f_dist:"Jarak (km)", act_f_kcal:"Kalori terbakar", act_f_hr:"Rata-rata BPM",
      act_need_dur:"Durasi wajib diisi dan harus lebih dari 0.",
      act_save_fail:"Gagal menyimpan. Coba lagi.", act_save:"Simpan", act_cancel:"Batal",
      act_load_fail:"Gagal memuat data activity.", act_retry:"Coba lagi",
      nav_activity:"Activity",
      rec_nutrition:"Perkiraan gizi",
      rec_portions:"Mau makan berapa porsi?",
      rec_portion_word:"porsi",
      rec_est_for:"untuk {n} porsi (perkiraan)",
      rec_ing_scale_badge:"×{n} dari resep asli",
      rec_ing_scale_note:"Jumlah bahan di bawah sudah diskalakan otomatis (perkiraan dari teks). Bahan tanpa angka jelas (mis. “secukupnya”) dibiarkan apa adanya — cek lagi bahan yang tak biasa.",
      rec_all_cat:"Semua kategori",
      rec_all_kcal:"Semua kalori",
      rec_sort_default:"Urutkan",
      rec_results:"resep",
      rec_reset:"Atur ulang",
      rec_min:"mnt",
      rec_by:"oleh",
      rec_load_more:"Muat lagi",
      rec_all:"Semua",
      rec_art_empty:"Belum ada artikel di sini.",
      rec_art_err:"Gagal memuat artikel.",
      rec_retry:"Coba lagi",
      rec_save:"Simpan",
      rec_saved:"Tersimpan",
      rec_saved_h:"Resep tersimpan",
      rec_saved_loading:"Memuat resep tersimpanmu…",
      rec_saved_none:"Belum ada yang disimpan. Buka satu resep lalu tekan Simpan supaya tersimpan di sini.",
      rec_saved_err:"Gagal memuat resep tersimpanmu.",
      rec_saved_gone:"{n} resep tersimpan sudah tidak tersedia.",
      rec_consent_required:"Setujui persetujuan dulu ya.",
