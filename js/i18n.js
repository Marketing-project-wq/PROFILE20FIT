...
(function () {
  const DICT = {
    en: {
      ...
      diet_mine_h:"Your submissions",
      diet_mine_empty:"No submissions yet. Send your first menu above!",
    ...
    id: {
      ...
      diet_mine_h:"Submission kamu",
      diet_mine_empty:"Belum ada submission. Kirim menu pertamamu di atas!",
