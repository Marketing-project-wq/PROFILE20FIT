...
(function () {
  const DICT = {
    en: {
      ...
      rec_ing_base_note:"Amounts below are the recipe's base ({n} serving(s)) — not scaled.",
    ...
    id: {
      ...
      rec_ing_base_note:"Jumlah bahan di bawah adalah takaran dasar resep ({n} porsi) — belum diskalakan.",
