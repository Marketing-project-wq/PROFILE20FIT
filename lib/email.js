...
function assertConfig() {
  const missing = [];
  // Nama var Railway = "RESEND.COM_EMAIL_API" (fallback EMAIL_RESEND_API / RESEND_API_KEY).
  // Laporkan nama kanonik supaya pesan setup langsung actionable di Railway.
  if (!RESEND_API_KEY) missing.push("RESEND.COM_EMAIL_API");
