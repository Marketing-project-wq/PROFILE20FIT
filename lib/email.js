...
// Nama env di Railway = EMAIL_RESEND_API (fallback RESEND_API_KEY bila dipakai).
const RESEND_API_KEY = process.env.EMAIL_RESEND_API || process.env.RESEND_API_KEY || "";
...
module.exports = { init, assertConfig, envInfo, send };
